...
public class Club {
    ...
    public Club(String clubid, String clubname, String image, String infomation, String managerName, String email, String phoneNumber, String location, String url, String updatingUrl) {
        this.clubid = clubid;
